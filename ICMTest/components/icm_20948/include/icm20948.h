...
#define ICM20948_I2C_ADDRESS       	0x69	/* I2C address for ICM20948*/
#define ICM20948_I2C_ADDRESS_1     	0x68 	/* Use this address if AD pin is grounded */
#define ICM20948_WHO_AM_I_VAL		0xEA 	/* Device ID */

// Not used but are defined 
#define ICM20948_I2C_MAG_ADDRESS   	0x0C 	/* I2C address for Magnetometer*/
#define ICM20948_WIA               	0x09 	/* Device ID Magnetometer */
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t icm20948_get_gyro(icm20948_handle_t sensor, icm20948_sensor_data_t *const gyro_value);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t icm20948_get_raw_gyro(icm20948_handle_t sensor, icm20948_raw_sensor_data_t *const raw_gyro_value);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t icm20948_get_acce(icm20948_handle_t sensor, icm20948_sensor_data_t *const acce_value);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t icm20948_get_raw_acce(icm20948_handle_t sensor, icm20948_raw_sensor_data_t *const raw_acce_value);
...
esp_err_t icm20948_mag_init(icm20948_handle_t sensor);

esp_err_t icm20948_get_raw_mag(icm20948_handle_t sensor, icm20948_raw_sensor_data_t *const raw_mag_value);
